...
//import model admin
const { User, Kuisioner, Kuisionerdetail, Hasilkuisioner } = require('../models');
    ...
    createItem : async (req,res) => {
        try {
            ...
            if (itemGet === null ) {
                ...
                res.status(200).json(response(200, 'success create item', hasilkuisCreate));
                ...
                res.status(201).json(response(201, 'success update item', hasilkuisUpdate));
